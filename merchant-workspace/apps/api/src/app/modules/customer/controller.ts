...
import {
  CommandCustomerCreate, CommandCustomerDelete, CommandCustomerUpdate
...
// router
router.get('/customer/:id(\\d+)', asyncHandler(getCustomer.handler))
router.get('/customers', asyncHandler(getCustomerList.handler))
