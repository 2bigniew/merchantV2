...
export class InvoiceRepository extends DB {
  ...
  public async updateInvoiceCustomer(id: number, customerId: Invoice["customerId"]): Promise<Invoice | undefined> {
    return this.updateInvoice({ id, customerId });
  }

  public async updateInvoiceAuthor(id: number, author: Invoice["author"]): Promise<Invoice | undefined> {
